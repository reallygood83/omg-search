...
export class ChatView extends ItemView {
	...
	private showWelcomeMessage() {
		...
		welcomeEl.createEl('div', { cls: 'gemini-chat-welcome-icon', text: '🤖' });
